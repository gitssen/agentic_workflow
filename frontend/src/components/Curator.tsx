...
export default function Curator() {
  ...
  return (
    <div className="flex h-full text-white selection:bg-indigo-500/30 font-sans pb-32">
      {/* Sidebar: Saved Playlists */}
      <aside className="hidden lg:flex w-80 glass border-r border-white/5 flex flex-col relative bg-zinc-950/20">
        <div className="p-8 border-b border-white/5">
           <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-500 flex items-center gap-2">
              <History size={14} />
              Saved Sequences
           </h2>
        </div>
      ...
      <main className="flex-1 relative overflow-y-auto custom-scrollbar">
        <div className="max-w-5xl mx-auto px-8 pt-12 pb-20">
            ...
            <div className="flex justify-center mb-12">
                <div className="flex p-1.5 glass rounded-2xl border border-white/5 bg-white/5 backdrop-blur-3xl">
                    <button 
                        ...
                        className={cn(
                            ...
                            activeTab === "curate" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : "text-zinc-500 hover:text-zinc-200"
                        )}
                    >
                        <Compass size={18} />
                        Curator
                    ...
                    <button 
                        ...
                        className={cn(
                            "flex items-center gap-3 px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all",
                            activeTab === "library" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : "text-zinc-500 hover:text-zinc-200"
                        )}
                    >
                        <Library size={18} />
                        Library
            ...
            {activeTab === "curate" ? (
                <>
                    ...
                    <form onSubmit={handleCurate} className="relative group">
                        ...
                        <div className="relative glass p-2 rounded-[3rem] flex items-center gap-2 border-white/5 group-focus-within:border-indigo-500/50 transition-all bg-white/5 backdrop-blur-3xl">
                        ...
                        <input 
                            ...
                            className="flex-1 bg-transparent py-4 px-4 text-lg font-bold placeholder-zinc-800 focus:outline-none tracking-tight text-white"
                        />
                        <button 
                            type="submit"
                    ...
                    {curatedPlaylist.length > 0 ? (
                        ...
                        <div className="flex items-center justify-between border-b border-white/5 pb-6">
                            <h2 className="text-xl font-black flex items-center gap-3 tracking-tight uppercase tracking-[0.1em]">
                ...
                <div className="space-y-8 pb-20">
                    ...
                    <div className="max-w-2xl mx-auto mb-16">
                        <div className="relative group">
                            ...
                            <div className="relative glass p-1 rounded-2xl flex items-center gap-2 border-white/5 group-focus-within:border-indigo-500/50 transition-all bg-white/5 backdrop-blur-3xl">
                                <div className="pl-6 text-zinc-500 group-focus-within:text-indigo-500 transition-colors">
                                    <Search size={20} />
                                </div>
                                <input 
                                    ...
                                    className="flex-1 bg-transparent py-4 px-4 text-base font-bold placeholder-zinc-800 focus:outline-none tracking-tight text-white"
                                />
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center justify-between border-b border-white/5 pb-6">
                            ...
                            <div className="flex items-center gap-4">
                                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">{librarySongs.length} Songs</span>
                                <div className="flex bg-white/5 p-1 rounded-xl border border-white/5">
                                    <button 
                                        onClick={() => setViewMode("grid")}
                                        className={cn(
            ...
            <AnimatePresence>
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    className="relative w-full max-w-md glass p-8 rounded-[2.5rem] border-white/10 shadow-2xl bg-zinc-900"
                    >
                    <button 
                        onClick={() => setIsSaveModalOpen(false)}
                    ...
                    <div className="space-y-4">
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 font-bold focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all placeholder-zinc-700 text-white"
                        />
                        <button 
